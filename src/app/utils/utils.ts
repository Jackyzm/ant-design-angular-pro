...
export function getTimeDistance(type) {
    ...
    if (type === 'today') {
        ...
        return [
            ...
            format(now.getTime() + (oneDay - 1000), 'YYYY-MM-DD HH:mm:ss')
        ];
    }
    ...
    if (type === 'week') {
        ...
        return [
            format(beginTime, 'YYYY-MM-DD HH:mm:ss'),
            format(beginTime + (7 * oneDay - 1000), 'YYYY-MM-DD HH:mm:ss')
        ];
    }
    ...
    if (type === 'month') {
        ...
        const time = Number(
            new Date(
                `${nextYear}-${fixedZero(nextMonth + 1)}-01 00:00:00`.replace(
                    /-/g,
                    '/'
                )
            )
        ...
        return [
            `${year}-${fixedZero(month + 1)}-01 00:00:00`,
            format(time - 1000, 'YYYY-MM-DD HH:mm:ss')
        ];
    }
